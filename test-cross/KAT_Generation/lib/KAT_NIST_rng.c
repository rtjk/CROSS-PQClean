/*******************************************************************************
 ...
 AND DATA ACCURACY. NIST NEITHER REPRESENTS NOR WARRANTS THAT THE OPERATION 
...
int KAT_NIST_randombytes(unsigned char *x, uint64_t xlen) {
